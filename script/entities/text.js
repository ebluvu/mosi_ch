...
return {
    ...
    drawNode: ({ nodes, nodeIndex = 0, canvas, context, fontData, fontDirection, timestamp, bgX = 0, bgY = 0, charsSoFar = 0, maxChars, spacingSoFar = 0, currentLine = 0, linesPerPage = 2, defaultTextColor = 'white' }) => {
        ...
        if (node.type === 'text') {
            ...
            let x = bgX + (fontData.width * textScale) // 文字比例：x1=1, x2=2
